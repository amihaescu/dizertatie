...
\begin{titlepage}
	...
	\vspace{1cm}
	{\scshape\Large Cercetare științifică\par}
	\vspace{1.5cm}
	{\huge\bfseries Arhitecturi software orientate pe servicii\par}
	\vspace{2cm}
	{\Large\bfseries Andrei Mihăescu\par}
	\vfill
	{\Large\bfseries
	Coordonator științific\par
	Conf. Dr. ~Eduard \textsc{Popovici}
	\vfill	}
% Bottom of the page
